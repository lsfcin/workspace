...
> [ ] [data-research] research available open data: Câmara dos Deputados API, TSE, other sources  
> [ ] [legal-check] consult on legal implications — defamation, data rights, political speech  
> [ ] [concept-doc] write core concept: what does a user do in their first session?  
> [ ] [mvp-scope] define MVP — one politician, one dimension of analysis, one flow  
