...
> [ ] [self-profile] test the profile questionnaire on yourself  
> [ ] [questionnaire-v1] design the full profile questionnaire — all dimensions  
> [ ] [plan-logic] how does a profile translate into plans A, B, C?  
> [ ] [user-research] profile 3 real users with different food contexts  
> [ ] [mvp-scope] one profile → one plan → one week of tracking  
