...
> [ ] [value-prop] write the core value proposition in 2 sentences  
> [ ] [user-research] talk to 3 people who feel stuck in their career path — what's their actual pain?  
> [ ] [concept-doc] define the matching logic: what data in, what recommendation out?  
> [ ] [mvp-scope] minimum flow — one person, one match, one path suggestion  
> [ ] [build-mvp] build and test with 5 real users  
