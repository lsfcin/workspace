---
name: "source-command-prepare"
description: "Migrated source command `prepare`"
---

# source-command-prepare

Use this skill when the user asks to run the migrated source command `prepare`.
...
Stop the interview once the intent is clear. Do **not** ask about implementation details (the Codex will handle that).
