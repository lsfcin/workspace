...
- EXPAND ACRONYMS on first use — write the term out in full the first time it appears, before discussing it. For a very specific concept, add a short footnote. Never assume a term is shared vocabulary.
