...
O *porquê*, os compromissos e as decisões ainda abertas ficam no goal:
[`brain/goals/google-migration.md`](../../brain/goals/google-migration.md) — `[fila-academy]`, `[fila-branches]` e `[fila-triagem]` são os três itens que apontam para cá.
...
| File | Description |
|------|-------------|
| [`ROADMAP.md`](ROADMAP.md) | Fila de download (cin → workspace local) |
<!-- routing:end -->
