...
- **Exempting Lucas's own writing from the retired-token check** — 2026-09-14 (Lucas): the three sentences where a
  retired spelling meant something the rename did not cover were rewritten instead. A blind spot is worse than a word.
