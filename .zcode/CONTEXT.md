...
The registration contract — what ZCode spawns, how its events map onto the canonical ones, and what is still unverified while the workspace is untrusted — is [`SPECS.md`](SPECS.md).
