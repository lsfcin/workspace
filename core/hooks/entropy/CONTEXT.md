...
| [`entropy_list.py`](entropy_list.py) | [`entropy_list.pyi`](entropy_list.pyi) | `retired_hits`, `item_slugs`, `duplicate_slugs`, `finished_work_hits`, `unanswered_placeholders` | Level 0 list and vocabulary checks, parsed from core/SCHEMA.md. Zero-token, deterministic. |
