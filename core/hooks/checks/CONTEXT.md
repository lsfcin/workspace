...
| [`pre-edit.py`](pre-edit.py) | [`pre-edit.pyi`](pre-edit.pyi) | `block` | PreToolUse: Edit|Write — size gate (limits.env BLOCK_LINES), first-line comment, CONTEXT.md description. |
