...
| [`session-prune.sh`](session-prune.sh) | — | — | SessionStart — prune stale session marker files (context seen-markers, facade reads, codegraph nudges) older than 2 days. See code/ROADMAP-verify.md W1. |
