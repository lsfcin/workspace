...
| [`stubs.py`](stubs.py) | [`stubs.pyi`](stubs.pyi) | `stub_out_dir`, `find_stubgen`, `emit_pyi`, `emit_dts`, `find_tsc` | Generate the interface for ONE file: the single copy of every stub-generator invocation. |
