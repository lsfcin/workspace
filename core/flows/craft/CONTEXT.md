...
| [`routing.md`](routing.md) | Which concrete model fills each tier, per provider; the availability check; the delegation direction; and how to refresh the table. **VOLATILE** — model ids and prices go stale. |
