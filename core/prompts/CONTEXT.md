...
| File | Description |
|------|-------------|
| [`agnostic-measurement.md`](agnostic-measurement.md) | ARCHITECTURE.html — one page, two purposes |
...
| [`slides-padroes.md`](slides-padroes.md) | Seven-step programme Lucas dictated on 2026-09-24: a /talks skill tree, a texpace check, and an audit of his whole slide style against the world's best. Delete when step 7 lands. |
<!-- routing:end -->
