...
| [`install.md`](install.md) | Install this workspace on the machine you are running on: probe every step in SETUP.md, report what is missing, and execute it. Takes one feature slug, or nothing for everything. |
...
| [`roundup.md`](roundup.md) | Full session-close ritual: drain the ledgers, route session knowledge to durable files, then verify and hand off. Use at session end. |
<!-- routing:end -->
