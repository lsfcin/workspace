...
4. **Cross-source.** When the topic spans current reality and academic literature, always use both `web_search` (or `core/tools/search`) and available paper-search tools.
