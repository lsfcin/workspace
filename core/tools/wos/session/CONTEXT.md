...
| [`session_turns.py`](session_turns.py) | [`session_turns.pyi`](session_turns.pyi) | `trusted_model`, `paths_for`, `turns` | session_turns.py — what counts as ONE assistant turn, and how much of it lands in the thread. |
