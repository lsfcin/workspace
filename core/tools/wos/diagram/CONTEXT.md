...
|------|-----------|-----|-------------|
| [`architecture`](architecture) | — | — | draw the workspace as it is (enforcement matrix, routing tree, folder mass) into one self-contained ARCHITECTURE.html; --check exits 1 when the committed file is stale |
