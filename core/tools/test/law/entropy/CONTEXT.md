...
| [`test_entropy_vendor.py`](test_entropy_vendor.py) | [`test_entropy_vendor.pyi`](test_entropy_vendor.pyi) | T0 the vendor-name guard (core/SCHEMA.md): a ledger assigns a TIER, never a model. Zero-token, runs in verify-fast. |
<!-- routing:end -->
