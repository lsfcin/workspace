...
| [`test_column_cap.py`](test_column_cap.py) | [`test_column_cap.pyi`](test_column_cap.pyi) | — | T0 column cap: how wide one authored .md line may be, and the four shapes exempt from it. Zero-token, runs in verify-fast. |
