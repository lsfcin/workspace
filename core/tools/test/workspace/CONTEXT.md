...
| [`test_b20260905_brain_drafts_carries_two_asymmetries.py`](test_b20260905_brain_drafts_carries_two_asymmetries.py) | [`test_b20260905_brain_drafts_carries_two_asymmetries.pyi`](test_b20260905_brain_drafts_carries_two_asymmetries.pyi) | `tracked`, `declared_subtrees` | b20260905 regression — a declared folder is carried by git, and a model named in a filename is attribution rather than a directive. |
...
| [`test_setup_executable.py`](test_setup_executable.py) | [`test_setup_executable.pyi`](test_setup_executable.pyi) | — | T0 the install is a procedure, not writing (core/SCHEMA.md § The .md type system): every SETUP.md step declares its feature and carries a precondition, an install and a verify check. |
<!-- routing:end -->
