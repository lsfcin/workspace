...
| [`test_b5_zcode_probe_registrations_removed.py`](test_b5_zcode_probe_registrations_removed.py) | [`test_b5_zcode_probe_registrations_removed.pyi`](test_b5_zcode_probe_registrations_removed.pyi) | — | T0 B5 regression — the zcode probe instruments are out and stay out. Zero-token, verify-fast. |
