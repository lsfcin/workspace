...
| [`test_shard_table.py`](test_shard_table.py) | [`test_shard_table.pyi`](test_shard_table.pyi) | A sharded type's index table (core/SCHEMA.md § What a part publishes about itself). |
<!-- routing:end -->
