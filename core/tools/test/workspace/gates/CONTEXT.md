...
| [`test_b20260901_the_codegraph_reminder_only_fires_when_a_stub_is_stale.py`](test_b20260901_the_codegraph_reminder_only_fires_when_a_stub_is_stale.py) | [`test_b20260901_the_codegraph_reminder_only_fires_when_a_stub_is_stale.pyi`](test_b20260901_the_codegraph_reminder_only_fires_when_a_stub_is_stale.pyi) | `indexed_project` | b20260901-the-codegraph-reminder-only-fires-when-a-stub-is-stale regression — a suggestion about the PROJECT fires for the project, not for the one file whose stub happens to be out of date. |
...
| [`test_memory_gate.py`](test_memory_gate.py) | [`test_memory_gate.pyi`](test_memory_gate.pyi) | `run` | T0 the memory gate: the workspace keeps no memory store, and a refused write is routed, not escalated. |
<!-- routing:end -->
