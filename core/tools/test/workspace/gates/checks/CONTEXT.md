...
| [`test_b7_durable_bug_slugs.py`](test_b7_durable_bug_slugs.py) | [`test_b7_durable_bug_slugs.pyi`](test_b7_durable_bug_slugs.pyi) | — | B7 regression — a bug id is a durable slug, and never borrowed. |
