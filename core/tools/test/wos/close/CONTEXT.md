...
| [`test_projects_map.py`](test_projects_map.py) | [`test_projects_map.pyi`](test_projects_map.pyi) | `repomap` | T1 the projects map (PROJECTS.md): what a redraw may fill in, and what it may never erase. |
