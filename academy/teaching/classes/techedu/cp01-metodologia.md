...
para o professor (ou o agente dele), na raiz do workspace — espelha e publica (~30 s):
   core/run tools/links/cfpages publish academy/teaching/classes/techedu/cp01-metodologia.md
web: https://lucassf.pages.dev/techedu/cp01 · raw: https://lucassf.pages.dev/techedu/cp01-metodologia.md
-->
