...
2026-08-31 · 2359 tracked files scanned · **38 findings here** (2026-08-25: 33 · +5 over 6 days) · 560 more across 27 nested repos, each in its own ISSUES.md
...
- core/refs/REFS.md — 6 line(s) over the 120-column cap (first at line 6)
- core/tools/verify/SPECS.md — 1 line(s) over the 120-column cap (first at line 2)
- core/tools/wos/diagram/views/CONTEXT.md — 1 line(s) over the 120-column cap (first at line 19)
...
- core/tools/test/workspace/gates — 10 code files in one directory, over the WARN_FILES signal; split by responsibility if the split removes more table than the hop adds
...
- . — feature/inbox-drain is 15 ahead of main
