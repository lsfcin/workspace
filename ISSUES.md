...
2026-09-11 · 743 tracked files scanned · **4 findings here** (2026-08-30: 40 · -36 over 12 days)
...
- core/tools/test/workspace/CONTEXT.md: routes to core/tools/test/workspace/test_b20260911_the_close_cannot_roll_back_a_file_git_has_never_seen.py, which this repo does not
- core/tools/test/workspace/CONTEXT.md: routes to core/tools/test/workspace/test_b20260911_the_close_cannot_roll_back_a_file_git_has_never_seen.pyi, which this repo does not

### Local branches holding unpromoted work

*promote when the work is green, or say which reason applies — /roundup Phase 5*

- . — feature/repo-map-and-promotion is 7 ahead of main
