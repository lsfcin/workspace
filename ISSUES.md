...
2026-09-01 · 2380 tracked files scanned · **30 findings here** (2026-08-25: 33 · -3 over 7 days) · 372 more across 27 nested repos, each in its own ISSUES.md
...
| Routing tables pointing at files git does not carry | 10 |
...
| [`code/aiwbot`](code/aiwbot/ISSUES.md) | 11 |
| [`code/apptime`](code/apptime/ISSUES.md) | 19 |
| [`code/corpora`](code/corpora/ISSUES.md) | 11 |
| [`code/cria`](code/cria/ISSUES.md) | 5 |
| [`code/dobra`](code/dobra/ISSUES.md) | 13 |
| [`code/flows`](code/flows/ISSUES.md) | 53 |
| [`code/freeai`](code/freeai/ISSUES.md) | 8 |
| [`code/gira`](code/gira/ISSUES.md) | 4 |
| [`code/isoroll-content`](code/isoroll-content/ISSUES.md) | 44 |
| [`code/isoroll-module`](code/isoroll-module/ISSUES.md) | 94 |
| [`code/laplata`](code/laplata/ISSUES.md) | 3 |
| [`code/obra`](code/obra/ISSUES.md) | 0 |
| [`code/ppc`](code/ppc/ISSUES.md) | 2 |
| [`code/spacemantics`](code/spacemantics/ISSUES.md) | 36 |
| [`code/voti`](code/voti/ISSUES.md) | 1 |
| **collected** | **402** |
...
- academy/lab/CONTEXT.md: routes to academy/lab/CHECKPOINTS-backup-2026-08-26.md, which this repo does not
- academy/papers/CONTEXT.md: routes to academy/papers/megatruth/CONTEXT.md, which this repo does not
- academy/reviews/2026-SVR-odt-safety-training/CONTEXT.md: routes to academy/reviews/2026-SVR-odt-safety-training/outputs/CONTEXT.md, which this repo does not
- brain/CONTEXT.md: routes to brain/drafts/context-folding-report.md, which this repo does not
- brain/attachments/CONTEXT.md: routes to brain/attachments/2026-07/instagram-video-by-bodam.sketch.md, which this repo does not
- branches/CONTEXT.md: routes to branches/writing/CONTEXT.md, which this repo does not
- branches/google-migration/CONTEXT.md: routes to branches/google-migration/ROADMAP.md, which this repo does not
- branches/writing/drafts/CONTEXT.md: routes to branches/writing/drafts/email/CONTEXT.md, which this repo does not
- branches/writing/drafts/CONTEXT.md: routes to branches/writing/drafts/mantras.md, which this repo does not
- code/CONTEXT.md: routes to code/eslint.shared.d.ts, which this repo does not
...
- . — feature/roadmap-shape is 3 ahead of main
