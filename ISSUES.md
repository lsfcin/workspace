...
2026-08-31 · 2366 tracked files scanned · **39 findings here** (2026-08-25: 33 · +6 over 6 days) · 560 more across 27 nested repos, each in its own ISSUES.md
...
- AGENTS.md — 1 line(s) over the 120-column cap (first at line 19)
...
- core/tools/test/workspace/gates — 12 code files in one directory, over the BLOCK_FILES cap; split by responsibility if the split removes more table than the hop adds
