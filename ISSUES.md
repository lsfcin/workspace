...
2026-09-23 · 989 tracked files scanned · **15 findings here** (2026-09-11: 2 · +13 over 12 days)
...
| Routing tables pointing at files git does not carry | 12 |
...
- academy/teaching/classes/ai4good/CONTEXT.md: routes to academy/teaching/classes/ai4good/agencia_conteudo.py, which this repo does not
- academy/teaching/classes/ai4good/CONTEXT.md: routes to academy/teaching/classes/ai4good/agencia_conteudo.pyi, which this repo does not
- academy/teaching/classes/ai4good/CONTEXT.md: routes to academy/teaching/classes/ai4good/autoaprimoramento_conteudo.py, which this repo does not
- academy/teaching/classes/ai4good/CONTEXT.md: routes to academy/teaching/classes/ai4good/autoaprimoramento_conteudo.pyi, which this repo does not
- academy/teaching/classes/ai4good/CONTEXT.md: routes to academy/teaching/classes/ai4good/autopreservacao_conteudo.py, which this repo does not
- academy/teaching/classes/ai4good/CONTEXT.md: routes to academy/teaching/classes/ai4good/autopreservacao_conteudo.pyi, which this repo does not
- academy/teaching/classes/ai4good/CONTEXT.md: routes to academy/teaching/classes/ai4good/lm_conteudo.py, which this repo does not
- academy/teaching/classes/ai4good/CONTEXT.md: routes to academy/teaching/classes/ai4good/lm_conteudo.pyi, which this repo does not
- academy/teaching/classes/ai4good/CONTEXT.md: routes to academy/teaching/classes/ai4good/slides_build.py, which this repo does not
- academy/teaching/classes/ai4good/CONTEXT.md: routes to academy/teaching/classes/ai4good/slides_build.pyi, which this repo does not
- academy/teaching/classes/ai4good/CONTEXT.md: routes to academy/teaching/classes/ai4good/slides_pecas.py, which this repo does not
- academy/teaching/classes/ai4good/CONTEXT.md: routes to academy/teaching/classes/ai4good/slides_pecas.pyi, which this repo does not

### Local branches holding unpromoted work

*promote when the work is green, or say which reason applies — /roundup Phase 5*

- . — feature/ai4good-disciplina is 3 ahead of main

### Local branches already merged into their base

*safe to delete, and purely local — `git -C <repo> branch -d <branch>`*

- . — 9 merged into main: git -C . branch -d feature/agnostic-read-measurement feature/bot-crossing feature/checker-honesty feature/hook-scoreboard feature/inbox-capture-honesty feature/legibility-identifiers feature/plain-vocabulary feature/roadmap-drain feature/word-retirement
...
- . — 9 merged into main: git -C . push origin --delete feature/agnostic-read-measurement feature/bot-crossing feature/checker-honesty feature/hook-scoreboard feature/inbox-capture-honesty feature/legibility-identifiers feature/plain-vocabulary feature/roadmap-drain feature/word-retirement
...
2026-09-22 · `verify.py full` · **green (25 passed, 972 deselected in 2.22s · 972 passed in 76.75s (0:01:16))**
<!-- verify:end -->
