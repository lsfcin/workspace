...
2026-09-02 · 678 tracked files scanned · **21 findings here** (2026-08-25: 33 · -12 over 8 days)
...
- core/hooks/SPECS.md — 362 lines, over the 200 cap; introduced by 02378322 lsfcin
...
- core/tools/test/workspace/gates — 15 code files in one directory, over the BLOCK_FILES cap; split by responsibility if the split removes more table than the hop adds
...
- . — feature/read-gate-prerequisites is 2 ahead of main
...
- . — 1 merged into main: git -C . branch -d feature/windows-parity
...
- . — 1 merged into main: git -C . push origin --delete feature/windows-parity
...
2026-09-02 · `verify.py full` · **green (676 passed, 5 skipped in 41.56s)**
<!-- verify:end -->
