...
2026-09-12 · 904 tracked files scanned · **13 findings here** (2026-08-31: 41 · -28 over 12 days)
...
- code/aiwbot/frontend/interview/CONTEXT.md: 2 truncated description(s) — askserver.py, askshape.py.
- code/aiwbot/frontend/session/CONTEXT.md: 1 truncated description(s) — anchor.py.
- code/aiwbot/frontend/stream/CONTEXT.md: 1 truncated description(s) — landing.py.
- code/aiwbot/frontend/turn/CONTEXT.md: 1 truncated description(s) — runner.py.
- code/aiwbot/frontend/voice/CONTEXT.md: 1 truncated description(s) — stt.py.
- code/aiwbot/tests/interview/CONTEXT.md: 4 truncated description(s) — test_f4_ask_wiring.py, test_f6_interview_shape.py, test_f7_opencode_ask.py, test_f8_ask_answer_shape.py.
- code/aiwbot/tests/seam/CONTEXT.md: 1 truncated description(s) — test_b4_opencode_cwd.py.
- code/aiwbot/tests/select/CONTEXT.md: 1 truncated description(s) — test_f3c_tap_latency.py.
- code/aiwbot/tests/store/CONTEXT.md: 1 truncated description(s) — test_b3_context_pct.py.
- code/aiwbot/tests/text/CONTEXT.md: 1 truncated description(s) — test_b1_table_bold.py.

### Local branches holding unpromoted work

*promote when the work is green, or say which reason applies — /roundup Phase 5*

- . — feature/absorb-aiwbot is 1 ahead of main

### Local branches already merged into their base

*safe to delete, and purely local — `git -C <repo> branch -d <branch>`*

- . — 1 merged into main: git -C . branch -d feature/repo-map-and-promotion
...
2026-09-11 · `verify.py full` · **green (20 passed, 855 deselected in 2.18s · 855 passed in 34.85s)**
<!-- verify:end -->
