...
- **The Antigravity lifecycle hook runner executes outside the workspace root, so relative `core/run` fails and blocks every tool call.**
  ...
  which immediately aborts all agent tool calls. The fallback is now `cd ~/workspace`, the link `sync-global-skills` creates on
  every machine — not the authoring mount, which `test_port_ceiling.py` forbids. Open until a regression spec proves a hook fired
  from `$HOME` reaches the dispatcher. `b20260925-antigravity-hook-cwd`
...
> Generated by `core/hooks/entropy/dashboard/entropy-dashboard.py`, which scans `/tmp/claude-1000/-mnt-workspace/4d703714-d54c-49f5-b812-c81235739394/scratchpad/wt-taste` and no other. Never edit inside this block, and never copy a count out of it — a copied number is the drift these checks exist to catch.

2026-09-26 · 958 tracked files scanned · **91 findings here**
...
| Retired tokens still alive | 76 |
| Roadmap item numbers cited outside a roadmap | 3 |
...
| Local branches holding unpromoted work | 3 |
...
- /: directory '/' is not lowercase kebab-case.
- AGENTS.md: AGENTS.md is declared root-only in core/SCHEMA.md.
- PROJECTS.md: PROJECTS.md is declared root-only in core/SCHEMA.md.

### Retired tokens still alive

*a rename is unfinished until these are zero*

- ISSUES.md: retired token '.loop' survives (line 313).
- ISSUES.md: retired token '/loops' survives (line 314).
- ISSUES.md: retired token 'BUGS.md' survives (line 315).
- ISSUES.md: retired token 'KNOWN-BUGS' survives (line 316).
- ISSUES.md: retired token 'WATCHLIST.md' survives (line 317).
- ISSUES.md: retired token 'blacklist' survives (line 318).
- ISSUES.md: retired token 'column cap' survives (line 319).
- ISSUES.md: retired token 'corpse' survives (line 320).
- ISSUES.md: retired token 'dial' survives (line 311).
- ISSUES.md: retired token 'fanout' survives (line 322).
- ISSUES.md: retired token 'hatchet' survives (line 323).
- ISSUES.md: retired token 'ledge' survives (line 324).
- ISSUES.md: retired token 'ledger' survives (line 325).
- ISSUES.md: retired token 'loop-architecture' survives (line 326).
- ISSUES.md: retired token 'loop-engineering' survives (line 327).
- ISSUES.md: retired token 'loop-router' survives (line 328).
- ISSUES.md: retired token 'mail-triage' survives (line 143).
- ISSUES.md: retired token 'nudge' survives (line 105).
- ISSUES.md: retired token 'pre-read.sh' survives (line 331).
- ISSUES.md: retired token 'probe' survives (line 332).
- ISSUES.md: retired token 'ratchet' survives (line 333).
- ISSUES.md: retired token 'scaffold' survives (line 310).
- ISSUES.md: retired token 'seam' survives (line 335).
- ISSUES.md: retired token 'shard' survives (line 336).
- ISSUES.md: retired token 'sidecar' survives (line 308).
- ISSUES.md: retired token 'slug' survives (line 337).
- ISSUES.md: retired token 'spine' survives (line 338).
- ISSUES.md: retired token 'substrate' survives (line 339).
- ISSUES.md: retired token 'telegram-capture' survives (line 340).
- ISSUES.md: retired token 'tier' survives (line 309).
...
- brain/drafts/taste-galeria-1.md: retired token 'dial' survives (line 39).
- brain/goals/burocracia-academica.md: retired token 'sidecar' survives (line 12).
- core/SCHEMA.md: retired token '.loop' survives (line 136).
- core/SCHEMA.md: retired token '/loops' survives (line 133).
- core/SCHEMA.md: retired token 'BUGS.md' survives (line 134).
- core/SCHEMA.md: retired token 'KNOWN-BUGS' survives (line 132).
- core/SCHEMA.md: retired token 'WATCHLIST.md' survives (line 135).
- core/SCHEMA.md: retired token 'blacklist' survives (line 157).
- core/SCHEMA.md: retired token 'column cap' survives (line 146).
- core/SCHEMA.md: retired token 'corpse' survives (line 154).
- core/SCHEMA.md: retired token 'dial' survives (line 158).
- core/SCHEMA.md: retired token 'fanout' survives (line 139).
- core/SCHEMA.md: retired token 'hatchet' survives (line 148).
- core/SCHEMA.md: retired token 'ledge' survives (line 156).
- core/SCHEMA.md: retired token 'ledger' survives (line 141).
- core/SCHEMA.md: retired token 'loop-architecture' survives (line 131).
- core/SCHEMA.md: retired token 'loop-engineering' survives (line 129).
- core/SCHEMA.md: retired token 'loop-router' survives (line 130).
- core/SCHEMA.md: retired token 'mail-triage' survives (line 147).
- core/SCHEMA.md: retired token 'nudge' survives (line 150).
- core/SCHEMA.md: retired token 'pre-read.sh' survives (line 138).
- core/SCHEMA.md: retired token 'probe' survives (line 145).
- core/SCHEMA.md: retired token 'ratchet' survives (line 152).
- core/SCHEMA.md: retired token 'scaffold' survives (line 151).
- core/SCHEMA.md: retired token 'seam' survives (line 142).
- core/SCHEMA.md: retired token 'shard' survives (line 140).
- core/SCHEMA.md: retired token 'slug' survives (line 144).
- core/SCHEMA.md: retired token 'spine' survives (line 153).
- core/SCHEMA.md: retired token 'substrate' survives (line 155).
- core/SCHEMA.md: retired token 'telegram-capture' survives (line 149).
- core/SCHEMA.md: retired token 'tier' survives (line 143).
- core/flows/_template.md: retired token 'sidecar' survives (line 100).
- core/flows/craft/prior-art.md: retired token 'sidecar' survives (line 13).
- core/flows/research/review.md: retired token 'sidecar' survives (line 59).
- core/flows/research/sota.md: retired token 'sidecar' survives (line 52).
- core/tools/chat/CONTEXT.md: retired token 'sidecar' survives (line 24).
- core/tools/chat/chat_transcribe.py: retired token 'sidecar' survives (line 1).
...
- core/tools/test/law/entropy/test_entropy_retired.py: retired token 'probe' survives (line 44).
- core/tools/test/law/entropy/test_entropy_retired.py: retired token 'shard' survives (line 42).
- core/tools/test/law/entropy/test_entropy_retired.py: retired token 'tier' survives (line 42).
...
- ISSUES.md: cites 'Frente 4.1' (line 360).
...
- brain/drafts/taste-galeria-1.md — 32461 characters, over the 18000 cap
- brain/drafts/taste-galeria-1.md — 410 lines, over the 250 cap; introduced by 0bf37c81 lsfcin

### Prose describing finished work

*git is the history — cut it, or rewrite it as present-tense state*

- core/SCHEMA.md:137: a dated completion report — prose describing finished work.
...
- . — feature/slides-taste is 9 ahead of main
...
- . — 11 merged into main: git -C . push origin --delete feature/agnostic-read-measurement feature/ai4good-disciplina feature/bot-crossing feature/cfpages-publish feature/checker-honesty feature/hook-scoreboard feature/inbox-capture-honesty feature/legibility-identifiers feature/plain-vocabulary feature/roadmap-drain feature/word-retirement
...
2026-09-24 · `verify.py full` · **green (25 passed, 974 deselected in 2.60s · 974 passed in 181.81s (0:03:01))**
<!-- verify:end -->
