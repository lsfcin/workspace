...
2026-09-16 · 941 tracked files scanned · **6 findings here** (2026-09-04: 26 · -20 over 12 days)
...
- academy/teaching/ai4good/CONTEXT.md:61: 1 unanswered placeholder(s).
- academy/teaching/tecnologias-na-educacao/CONTEXT.md:127: 1 unanswered placeholder(s).

### Truncated routing descriptions

*the source wrote past the bound — shorten it there, never edit the table*

- academy/teaching/ai4good/CONTEXT.md: 1 truncated description(s) — transformers-guia-acessivel-slides.md.

### Local branches holding unpromoted work

*promote when the work is green, or say which reason applies — /roundup Phase 5*

- . — feature/roadmap-drain is 8 ahead of main
...
>       assert failures == [], '\n'.join(failures)
E       AssertionError: /mnt/workspace/academy/teaching/ai4good/CONTEXT.md: 1 truncated description(s) — transformers-guia-acessivel-slides.md.
E            The source wrote past the 360-character bound. Shorten the description
E            at its source, then regenerate; never edit the table.
E       assert ['/mnt/worksp...t the table.'] == []
E         
E         Left contains one more item: '/mnt/workspace/academy/teaching/ai4good/CONTEXT.md: 1 truncated description(s) — transformers-guia-acessivel-slides.m... wrote past the 360-character bound. Shorten the description\n   at its source, then regenerate; never edit the table.'
E         Use -v to get more diff

core/tools/test/law/entropy/test_entropy_context.py:35: AssertionError
=========================== short test summary info ============================
FAILED core/tools/test/law/entropy/test_entropy_context.py::test_no_routing_block_publishes_half_a_sentence
1 failed, 923 passed in 47.43s
```
<!-- verify:end -->
