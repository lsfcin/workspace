...
2026-09-26 · 965 tracked files scanned · **94 findings here**
...
- core/skills/slides/design-system.md: retired token 'nudge' survives (line 7).
...
- core/tools/slides — 11 code files in one directory. NOT REFUSED — this is the warning at 10. Nothing stops until 15; split by responsibility if the split removes more table than the hop adds
- core/tools/test — 11 code files in one directory. NOT REFUSED — this is the warning at 10. Nothing stops until 15; split by responsibility if the split removes more table than the hop adds
