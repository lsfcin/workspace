...
2026-08-30 · 2339 tracked files scanned · **40 findings here** (2026-08-25: 33 · +7 over 5 days) · 560 more across 27 nested repos, each in its own ISSUES.md
...
- SETUP.md — 593 lines, over the 200 cap; introduced by 3e575bb lsfcin
...
- . — feature/os-agnostic-port is 22 ahead of main
...
>       return io.open(self, mode, buffering, encoding, errors, newline)
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
E       FileNotFoundError: [Errno 2] No such file or directory: '/mnt/workspace/core/permissions.txt'

/usr/lib/python3.14/pathlib/__init__.py:772: FileNotFoundError
=========================== short test summary info ============================
FAILED core/tools/test/workspace/test_corpus_ratchet.py::test_prose_describing_finished_work_does_not_grow
FAILED core/tools/test/workspace/test_corpus_ratchet.py::test_unanswered_placeholders_do_not_grow
FAILED core/tools/test/workspace/test_corpus_ratchet.py::test_constraints_in_context_heads_do_not_grow
FAILED core/tools/test/wos/test_permissions.py::test_every_level_declares_what_it_means_and_what_it_costs
FAILED core/tools/test/wos/test_permissions.py::test_the_levels_really_are_ordered_by_how_much_they_permit
FAILED core/tools/test/wos/test_permissions.py::test_only_the_open_level_stops_asking_about_secrets
FAILED core/tools/test/wos/test_permissions.py::test_a_harness_pattern_never_appears_in_the_registry
FAILED core/tools/test/wos/test_permissions.py::test_check_notices_a_config_that_no_longer_matches
8 failed, 599 passed in 82.59s (0:01:22)
```
<!-- verify:end -->
