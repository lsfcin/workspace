...
2026-09-26 · 958 tracked files scanned · **102 findings here**
...
| Routing tables pointing at files git does not carry | 11 |
...
- core/tools/slides/CONTEXT.md: routes to core/tools/slides/pptx, which this repo does not
- core/tools/slides/CONTEXT.md: routes to core/tools/slides/pptx_layouts.py, which this repo does not
- core/tools/slides/CONTEXT.md: routes to core/tools/slides/pptx_layouts.pyi, which this repo does not
- core/tools/slides/CONTEXT.md: routes to core/tools/slides/pptx_masters.py, which this repo does not
- core/tools/slides/CONTEXT.md: routes to core/tools/slides/pptx_masters.pyi, which this repo does not
- core/tools/slides/CONTEXT.md: routes to core/tools/slides/pptx_shapes.py, which this repo does not
- core/tools/slides/CONTEXT.md: routes to core/tools/slides/pptx_shapes.pyi, which this repo does not
- core/tools/slides/CONTEXT.md: routes to core/tools/slides/pptx_theme.py, which this repo does not
- core/tools/slides/CONTEXT.md: routes to core/tools/slides/pptx_theme.pyi, which this repo does not
- core/tools/test/CONTEXT.md: routes to core/tools/test/test_pptx.py, which this repo does not
- core/tools/test/CONTEXT.md: routes to core/tools/test/test_pptx.pyi, which this repo does not
...
- ISSUES.md: cites 'Frente 4.1' (line 387).
...
- brain/drafts/taste-galeria-1.md — 35778 characters, over the 18000 cap
- brain/drafts/taste-galeria-1.md — 463 lines, over the 250 cap; introduced by 0bf37c81 lsfcin
...
- . — feature/slides-taste is 10 ahead of main
