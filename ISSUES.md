...
2026-09-23 · 985 tracked files scanned · **4 findings here** (2026-09-11: 1 · +3 over 12 days)
...
| Routing tables pointing at files git does not carry | 2 |
...
- academy/teaching/structure/CONTEXT.md: routes to academy/teaching/structure/painel.py, which this repo does not
- academy/teaching/structure/CONTEXT.md: routes to academy/teaching/structure/painel.pyi, which this repo does not
