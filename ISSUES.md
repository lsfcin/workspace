...
2026-09-01 · 677 tracked files scanned · **19 findings here** (2026-08-25: 33 · -14 over 7 days)
...
- core/tools/test/workspace/gates — 14 code files in one directory, over the BLOCK_FILES cap; split by responsibility if the split removes more table than the hop adds
...
- . — feature/windows-parity is 4 ahead of main
...
2026-09-01 · `verify.py full` · **green (669 passed, 5 skipped in 41.61s)**
<!-- verify:end -->
