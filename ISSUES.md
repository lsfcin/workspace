...
2026-08-29 · 710 tracked files scanned · **46 findings here** (2026-08-25: 33 · +13 over 4 days)
...
| Size signals | 25 |
| Source files with no interface stub | 6 |
...
- core/tools/verify/contract.py — no .pyi
- core/tools/wos/close/artifacts.py — no .pyi
- core/tools/wos/close/branches.py — no .pyi
- verify.py — no .pyi
...
- . — feature/os-agnostic-port is 4 ahead of main
