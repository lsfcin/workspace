...
- ROADMAP.md — 222 lines, over the 200 cap; introduced by feeca22 lsfcin
...
- . — feature/os-agnostic-port is 13 ahead of main
...
.....................                                                    [100%]
================================== FAILURES ===================================
_________________ test_a_posix_only_venv_path_does_not_spread _________________
...
E       AssertionError: 19 versioned files name .venv/bin, up from 18. That directory is .venv/Scripts on Windows, and core/hooks/platform_law.py owns the difference
E       assert 19 <= 18

core\tools\test\workspace\test_port_ratchet.py:74: AssertionError
=========================== short test summary info ===========================
FAILED core/tools/test/workspace/test_port_ratchet.py::test_a_posix_only_venv_path_does_not_spread
1 failed, 592 passed, 4 skipped in 112.61s (0:01:52)
```
<!-- verify:end -->
