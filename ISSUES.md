...
2026-09-14 · 909 tracked files scanned · **6 findings here** (2026-09-02: 22 · -16 over 12 days)
...
- code/aiwbot/frontend/SPECS.md — 1 line(s) over the 120-column cap (first at line 21)

### Unanswered scaffold placeholders

*a generator asked a question — answer it at the source, never by cutting the marker*

- core/tools/test/video/CONTEXT.md:9: 1 unanswered placeholder(s).

### Local branches holding unpromoted work

*promote when the work is green, or say which reason applies — /roundup Phase 5*

- . — feature/legibility-identifiers is 4 ahead of main
