...
2026-09-21 · 973 tracked files scanned · **3 findings here** (2026-09-09: 1 · +2 over 12 days)
...
- . — feature/inbox-capture-honesty is 2 ahead of main

### Local branches already merged into their base

*safe to delete, and purely local — `git -C <repo> branch -d <branch>`*

- . — 6 merged into main: git -C . branch -d feature/bot-crossing feature/checker-honesty feature/hook-scoreboard feature/legibility-identifiers feature/roadmap-drain feature/word-retirement
...
- . — 6 merged into main: git -C . push origin --delete feature/bot-crossing feature/checker-honesty feature/hook-scoreboard feature/legibility-identifiers feature/roadmap-drain feature/word-retirement
