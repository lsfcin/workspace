...
2026-09-02 · 2393 tracked files scanned · **23 findings here** (2026-08-25: 33 · -10 over 8 days) · 399 more across 27 nested repos, each in its own ISSUES.md
...
- . — feature/port-seams is 1 ahead of main
...
- . — feature/roadmap-shape is 27 ahead of origin/feature/roadmap-shape
...
- . — 1 merged into main: git -C . push origin --delete feature/read-gate-close
...
2026-09-02 · `verify.py full` · **green (1 passed, 695 deselected in 2.31s · 695 passed in 54.02s)**
<!-- verify:end -->
