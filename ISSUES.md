...
2026-09-26 · 987 tracked files scanned · **7 findings here** (2026-09-14: 3 · +4 over 12 days)
...
- core/tools/test — 12 code files in one directory. NOT REFUSED — this is the warning at 10. Nothing stops until 15; split by responsibility if the split removes more table than the hop adds

### Local branches holding unpromoted work

*promote when the work is green, or say which reason applies — /roundup Phase 5*

- . — feature/pdf-twin is 27 ahead of main
...
2026-09-26 · `verify.py full` · **red**

```
tmp_path = PosixPath('/tmp/pytest-of-lucas/pytest-29/popen-gw11/test_a_missing_stub_is_announc0')
...
E       AssertionError: the gate was OFF for nostub.py and said nothing:
E         ''
E       assert 'NO INTERFACE' in ''
E        +  where '' = CompletedProcess(args=['sh', '/mnt/workspace/core/run', 'hooks/read/pre-read.py'], returncode=0, stdout='', stderr='').stdout

core/tools/test/workspace/gates/test_b20260831_silent_stub_gate.py:46: AssertionError
=========================== short test summary info ============================
FAILED core/tools/test/workspace/gates/test_b20260831_silent_stub_gate.py::test_a_missing_stub_is_announced_and_the_read_is_allowed
1 failed, 1036 passed in 198.10s (0:03:18)
```
<!-- verify:end -->
