...
2026-09-18 · 961 tracked files scanned · **5 findings here** (2026-09-06: 15 · -10 over 12 days)
...
- academy/teaching/structure/templates/CONTEXT.md: routes to academy/teaching/structure/templates/template-artefato.md, which this repo does not
- academy/teaching/structure/templates/CONTEXT.md: routes to academy/teaching/structure/templates/template-checkpoint.md, which this repo does not
...
2026-09-17 · `verify.py full` · **green (25 passed, 936 deselected in 2.48s · 936 passed in 54.31s)**
<!-- verify:end -->
