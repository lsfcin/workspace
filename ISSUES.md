...
2026-09-01 · 674 tracked files scanned · **20 findings here** (2026-08-25: 33 · -13 over 7 days)
...
- SETUP.md — 609 lines, over the 200 cap; introduced by 3e575bbd lsfcin
...
- core/SCHEMA.md — 220 lines, over the 200 cap; introduced by 5c22650f lsfcin
- core/SPECS.md — 266 lines, over the 200 cap; introduced by 4c3d952a lsfcin
- core/hooks/SPECS.md — 361 lines, over the 200 cap; introduced by 02378322 lsfcin
...
- core/tools/test/workspace — 11 code files in one directory, over the BLOCK_FILES cap; split by responsibility if the split removes more table than the hop adds
...
- . — feature/windows-parity is 3 ahead of main
...
- . — 1 merged into main: git -C . push origin --delete feature/roadmap-shape
...
2026-09-01 · `verify.py full` · **green (659 passed, 5 skipped in 172.24s (0:02:52))**
<!-- verify:end -->
