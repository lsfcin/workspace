...
2026-09-21 · 971 tracked files scanned · **3 findings here** (2026-09-09: 2 · +1 over 12 days)
...
- . — feature/checker-honesty is 1 ahead of main

### Local branches already merged into their base

*safe to delete, and purely local — `git -C <repo> branch -d <branch>`*

- . — 5 merged into main: git -C . branch -d feature/bot-crossing feature/hook-scoreboard feature/legibility-identifiers feature/roadmap-drain feature/word-retirement
