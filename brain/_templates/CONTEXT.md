...
| [`goals/_template.md`](goals/_template.md) | [ area | subarea | horizon ] goal title |
| [`goals/example.md`](goals/example.md) | [ craft | workspace | now ] learn this brain by using it |
<!-- routing:end -->
