...
Hades, which is hand-painted at artist cost. **REPLAN 2026-07-29 (MVP-first)**: renderer boundary frozen, content strategy
demoted from prerequisite to an A/B behind it, after four review rounds stalled on arm-A stair enclosure masks. Order:
freeze boundary → **playable in Foundry with ugly pixels and all 8+1 views** → content bake-off (kit-sprite vs scene-cell
...
**ease-start**  
Nothing to set up on your side. The boundary freeze + cabin fixture run in `code/isoroll-content` (ROADMAP § BOUNDARY), then the
...
> [ ] [bakeoff] content arms compared behind the frozen boundary: A kit-sprite (baseline) vs B scene-cell world-uv render
...
## stats
<!-- stats:start -->
last-touch: 2026-09-11  ·  trend: steady  ·  touches: 74/339/668/668/668/668
<!-- stats:end -->
