...
Construir o projeto das casinhas. Pasta existe em branches/casinhas/. Move from plan to built. Transformative because it
changes what's possible — financially, spatially, in terms of autonomy.
...
2026-08-28: cartório resolvido — processo 45.992 (titularidade → demarcação) entrou presencialmente em 22/07, está em
exame, e a última exigência (certidão de endereço, R$ 267,80) foi paga hoje. Novo gargalo = **Teste de Absorção do Solo
com ART**: a Licença Prévia Ambiental está quase aprovada e a fase seguinte (Licença de Instalação) exige projeto de
esgoto, que exige esse teste. Marcelo cobrou 15/08, 19/08, 24/08 e 28/08 — é o único item aberto com ele.
...
**ease-start**  
Mandar UMA mensagem pra Tecsolo Sondagens cobrando o orçamento que eles prometeram em 28/08. Fones: 3227-4780,
...
> [ ] [teste-absorcao] Teste de Absorção do Solo com ART — cobrar orçamento da Tecsolo; destrava a Licença de
> Instalação  
> [ ] [fotos-internas] mandar a Marcelo as fotos internas do terreno (áreas livres entre construção e muros) — última
> pendência da Licença Prévia Ambiental  
...
> [ ] [decidir-40cm] decidir como dar os 40 cm às casas — aterro ou laje suspensa com vão de manutenção; critério é
> o mais barato, falta o número  
...
> R$385k só-MO; Reforme Fácil sem valor extraído; Cristiano nunca orçou) — falta normalizar (S5)  
