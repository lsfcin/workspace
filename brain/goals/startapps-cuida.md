...
> [ ] [define-directed] define what "directed" means — contact to recommendation in 2 sentences  
> [ ] [service-map] map health services in Recife: what categories, what's available, how to reach them  
> [ ] [conversation-design] design the intake conversation — what questions, in what order?  
> [ ] [recommendation-logic] how does the conversation map to a recommendation?  
> [ ] [prototype] build and test with 3 real people  
