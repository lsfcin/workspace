...
> [ ] [data-hunt] find one public dataset of financial flows — IBGE, Banco Central open data  
> [ ] [viz-concept] what does the ideal visualization look like? sketch it  
> [ ] [stack-choose] pick a data visualization stack  
> [ ] [first-viz] build one meaningful visualization from real data  
> [ ] [insight-test] show to 3 people — does it reveal something they didn't know?  
