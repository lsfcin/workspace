...
> [ ] [poli-01] define MVP scope — politician timeline vs. full crawler  
> [ ] [poli-02] identify data sources — news APIs, official records, social feeds  
> [ ] [poli-03] design timeline data model — facts, speeches, votes, events  
> [ ] [poli-04] build crawler prototype for one source  
> [ ] [poli-05] build minimal UI — one politician, one timeline  
