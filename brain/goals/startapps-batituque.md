...
> [ ] [matrix-prototype] prototype one rhythm matrix in any tool — 8 beats × 3 instruments  
> [ ] [sound-design] map what sounds each instrument needs — pandeiro has how many distinct touches?  
> [ ] [ui-concept] sketch the expand-collapse hierarchy as a UI wireframe  
> [ ] [playback-prototype] build a working playback prototype — web audio API or equivalent  
> [ ] [mvp] full matrix editor with play, loop, and 3 instruments  
