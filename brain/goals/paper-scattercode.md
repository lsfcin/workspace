...
> [ ] [design-experiment] write one-page experiment design: hypothesis, conditions, metrics, languages  
> [ ] [related-work] find 3-5 papers on LLM coding benchmarks and code structure — skim abstracts  
> [ ] [baseline-setup] set up baseline: one language, one task, two conditions (modular vs monolithic)  
> [ ] [run-pilot] run pilot with one model — check if measurements behave as expected  
> [ ] [expand-languages] extend to 2+ languages  
> [ ] [write-paper] draft paper from results  
