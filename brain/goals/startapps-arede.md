...
> [ ] [criteria] define what makes a brand "bad" — 3 criteria for company scoring  
> [ ] [data-sources] find existing data sources: company ESG scores, labor complaints, news APIs  
> [ ] [concept-doc] what does a user do in their first session? what decision does the app help with?  
> [ ] [mvp-scope] one category of products, one set of criteria, one recommendation flow  
