...
> [ ] [ab-test] run a small A/B test — same content posted with and without engagement-bait framing  
> [ ] [algorithm-research] research what signals platforms use to boost content — existing literature  
> [ ] [image-obfuscation] research: can image content be made OCR-resistant but human-readable?  
> [ ] [prototype] build a minimal version: take text → produce image with mask  
> [ ] [test-boost] test if protected image gets different algorithmic treatment  
