...
> direto no `yt-dlp`. Não roteamos link que não foi lido. **Reexportar o cookie do navegador logado é
> ação do Lucas**; depois disso uma triagem nova limpa as 8 de uma vez. Rastreado em
> `brain/goals/workspace-os.md` `[extracao-bloqueada]`.

https://www.instagram.com/p/DdQ3fXJjXDG/?utm_source=ig_web_copy_link
colocar nas minhas aulas
— via aiwbot · 2026-09-14
(extração falhou 2026-09-14: cookie do Instagram vencido)
...
(extração falhou 2026-09-05 e de novo 2026-09-14: cookie do Instagram vencido)
