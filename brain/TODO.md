...
- [ ] [workspace-os / M4-video] melhorar `relevance()` — hoje embeda o arquivo inteiro do goal, e goals longos/diversos (`rpg-isoroll`) viram atratores falsos pra qualquer conteúdo técnico. Ideia: descritor curto escrito à mão por goal (1-2 frases) como alvo do embedding, em vez do arquivo todo. Correção de hubness já testada e rejeitada — ver `core/tools/video.SETUP.md` (2026-07-23)
